...
rule fastqc_raw:
    input:
        r1="results/raw/{sample}_1.fastq.gz",
        r2="results/raw/{sample}_2.fastq.gz"
    output:
...
rule fastp:
    input:
        ...
        r2="results/raw/{sample}_2.fastq.gz"
    output:
        r1_trim="results/trimmed/{sample}_1.trim.fastq.gz",
        r2_trim="results/trimmed/{sample}_2.trim.fastq.gz",
...
rule fastqc_trimmed:
    ...
    output:
        html1="results/fastqc/trimmed/{sample}_1_fastqc.html",
        html2="results/fastqc/trimmed/{sample}_2_fastqc.html"
    shell:
